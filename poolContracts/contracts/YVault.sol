...
contract YFVault is ERC20, ERC20Detailed, Ownable {
    ...
    string private constant NAME = "yfBETA TOKEN_NAME";
    string private constant SYMBOL = "yfTOKEN_SYMBOL";
    uint8 private constant DECIMALS = 6;
    address private constant ADDRESS_TOKEN = address(0);
    address private constant ADDRESS_VAULT = address(0);
